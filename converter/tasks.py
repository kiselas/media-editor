...
from converter.utils import validate_video_to_gif_data, compress_gif
...
from django_media_editor.constants import FileStatus, FULL_PATH_TO_PROCESSED_FILES, CONVERT_FORMAT_PARAMETERS, \
    FILE_LIFETIME, FFMPEG_COMPRESSION_PRESET, MAX_VIDEO_TO_GIF_DURATION
...
def convert_video_to_gif(path_to_original_file, file_identifier, file_format, start_time, end_time, quantize_algorithm):
    ...
    try:
        ...
        logger.info(f'[video_to_gif] STAGE 1: Convert video to gif')
        reader = imageio.get_reader(path_to_original_file)
